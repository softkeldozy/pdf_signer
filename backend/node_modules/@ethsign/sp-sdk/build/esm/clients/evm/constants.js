import { zetachainAthensTestnet, opBNBTestnet, polygon, opBNB, mainnet, scrollSepolia, scroll, base, plumeTestnet, berachainTestnet, baseSepolia, zetachain, sepolia, polygonAmoy, optimism, gnosisChiado, optimismSepolia, arbitrumSepolia, polygonMumbai, gnosis, degen, xLayer, cyber, arbitrum, bsc, celo, celoAlfajores, plume, monadTestnet, } from 'viem/chains';
...
export const chainInfo = {
    evm: [
        ...
        },
        {
            ...
            chain: EvmChains.monadTestnet,
            icon: 'https://sign-public-cdn.s3.us-east-1.amazonaws.com/sp-sdk/icons/Monad_250331022304.svg',
            scanUrl: monadTestnet.blockExplorers.default.url + '/tx/',
            id: monadTestnet.id + '',
            isTestnet: true,
            chainInfo: monadTestnet,
        },
    ],
    offchain: [
        {

...
export class EVMOnChainClient implements SignProtocolClientBase {
  ...
  async createSchema(
    ...
    options?: CreateSchemaOnChainOptions
  ...
  async getSchema(schemaId: string): Promise<OnChainSchema> {
  ...
  async revokeAttestation(
    ...
    const revokeAbis: any = abiJson.abi.filter(
      (item: any) => item.name === 'revoke'
    );
  ...
  async createAttestation(
    ...
    if (delegationSignature) {
      ...
      if (!validateObject(data, schemaData as SchemaItemOnChain[])) {
      ...
      attestationData = {
        ...
        data: encodeOnChainData(
          ...
          handledData.schemaData as SchemaItemOnChain[]
        ),
      };
    }
    const params: any = [
  ...
  async getAttestation(attestationId: string): Promise<Attestation> {
    ...
    const data = decodeOnChainData(
      res.data,
      res.dataLocation,
      schemaData as SchemaItemOnChain[]
    );
